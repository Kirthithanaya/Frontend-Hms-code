...
import SendNotification from "../../components/AdminComponent/Notification/SendNotification";
import SendSMS from "../../components/AdminComponent/Notification/SendSMS ";
...
const SendNotificationAdmin = () => {
  ...
  return (
    <div className="p-6 max-w-6xl mx-auto">
      <div>
        <h2 className="text-4xl font-bold text text-blue-500 text-center mb-6">
          Send Notification
        </h2>
      </div>
